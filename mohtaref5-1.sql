...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2024 at 11:54 PM
...
(1, 2, 100, 200, 25, 1, 11, 'new'),
(2, 1, 50, 50, 27, 1, 12, 'new');
...
INSERT INTO `payments` (`pay_id`, `pay_name`, `pay_no`, `valid_date`, `cvv`, `user_id`) VALUES
(1, 'mohamed jamal', '539230.520', '252024', '123', 13);
...
INSERT INTO `rating` (`id`, `rate_no`, `comment`, `product_id`, `user_id`) VALUES
(3, 5, 'ممتاز', 25, 14);
...
(14, 'احمد طارق عباس يحيي', 'ahmedtarekya100@gmai', '$2y$10$3qJLfoRoSOa0HXlpUHRikuwNhCEQ7zLj7jpZy/p8C2TP/LTVCGtUK', 'uploads/users/3429018232.jpg', '964545487', NULL);
...
--
ALTER TABLE `payments`
  ADD CONSTRAINT `payment_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
