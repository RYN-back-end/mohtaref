...
CREATE TABLE `orders` (
  ...
  `status` enum('new','accepted','refused','ended') DEFAULT 'new',
...
INSERT INTO `professionals` (`id`, `title`, `banner`, `email`, `whatsapp`, `password`, `address`, `pro_desc`) VALUES
(11, 'مفرحة', 'uploads/professionals/3422477916.jpg', 'mfreha@gmail.com', '96655852', '$2y$10$oGQ5ogtGzeq6Ul2vGLzbEeIXPnc/XY0mkmhYlfSmk7Rygltd/gIw2', 'المدينة', ''),
(12, 'مريم', 'uploads/professionals/3422481204.jpg', 'mar@gmail.com', '966558522', '$2y$10$.jccEqfeRL2AWBl2W34o8e7BhQVYiGLM5N6fc2.HbT3VfE/CW7Lu2', 'الرياض', ''),
(13, 'روان', 'uploads/professionals/3427236928.jpg', 'rawan@gmail.com', '05555888', '$2y$10$Ip51qYPkwyEK49GNjBuQnedixB/Ud5S4BEY7eXqs6JQQHsRiMbDKC', 'المدينة', '');
...
(12, 'ملك', 'mariam@gmail.com', '$2y$10$CsfP8o50DkN42ygL4ondJuHrxPJitOCP08qkr1o3b6isQmEfDkfIS', 'uploads/users/3426528528.jpg', '95658332222', NULL);
